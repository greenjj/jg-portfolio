...
## 📖 Overview
UPDATE: This work has resulted in a paper published in IEEE Transactions of Field Robotics. You can check it out [here](https://ieeexplore.ieee.org/document/11175225). Here's the abstract:
...
## 📊 Images
Note: These figures pulled from the publication linked above
